...
typedef struct sw
{
  ...
  rsuite_t ** suite;      /* suite implemented in the shared object and executed */
...
sw_t ** run_suite (rsuite_t * suite [], sw_t * sw [], unsigned loops, unsigned items, bool verbose, bool quiet);
...
void hall_of_fame (rsuite_t * suite [], sw_t * plugins [], unsigned maxn, unsigned loops, unsigned items);
void print_ranking (rsuite_t * suite [], sw_t * plugins [], unsigned maxn);
