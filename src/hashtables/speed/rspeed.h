...
sw_t ** run_suite (rhtsuite_t * suite [], sw_t * sw [], unsigned loops, unsigned items, bool verbose, bool quiet);
...
void hall_of_fame (rhtsuite_t * suite [], sw_t * plugins [], unsigned maxn, unsigned loops, unsigned items);
